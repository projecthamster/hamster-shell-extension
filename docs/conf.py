...
# -*- coding: utf-8 -*-
#
# shell-extension documentation build configuration file, created by
...
html_theme_options = {
    ...
    # 'logo': 'logo.png',
    'logo_name': True,
    'description': 'Gnome-Shell-Extention for Project Hamster',
    'github_user': 'projecthamster',
    'github_repo': 'shell-extension',
    'github_button': True,
    'github_banner': False,
    'travis_button': False,
    'analytics_id': '',
...
htmlhelp_basename = 'shell-extensiondoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'shell-extension.tex',
     u'hamster-shell-extension Documentation',
